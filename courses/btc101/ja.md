...
このコースでは、ビットコインという技術をわかりやすく効果的に理解できるよう、ビットコインの基礎を25章に分けて解説します。このコースでは、マイニング、ウォレット、売買のプラットフォームなど業界全体の基礎を探求します。学習の過程で追加教材も提供される予定です。また、このコースを修了後、リソースセクションの「21 Posters」もご覧ください。
