...
貨幣の定義と社会における機能（第 1 章）を紹介する前に、ビットコインの成り立ちから始めましよう。2009年に誕生したビットコインは、他に類を見ない比較的新しい技術です。そのため、全てを一度に理解できなくても当然です。実際、インターネットの使い方や車の運転の方法を学ぶ場合と同様に、技術的な詳細を今すぐ全て知る必要はありません。まずは資金の受け取り方、支払い方、保護方法などを学ぶことから始め、その後少しずつ、より深く学んでいけばよいのです。
