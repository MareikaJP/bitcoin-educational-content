---
name: ビットコインの旅
goal: ビットコインの基礎となる、貨幣的なバリュープロポジション、マイナー、トランザクション、ウォレットについて学びましょう。
objectives:
  - ビットコイン技術の概要を理解する
  - ビットコインの購入方法と安全な保管方法を理解する
  - ブロックチェーン技術の概要を理解する
  - ライトニングネットワークの概念に慣れる
...
このコースでは、ビットコインという技術をわかりやすく効果的に理解できるよう、ビットコインの基礎を25章に分けて解説します。このコースでは、マイニング、ウォレット、売買のプラットフォームなど、業界全体の基礎を探求します。学習の過程で追加教材も提供される予定です。また、このコースを修了後には、リソースセクションの「21 Posters」もご覧ください。

本コースを始めるにあたり、事前知識は一切不要です。BTC 101は経験の度合いに関わらず、誰もが理解できるように設計されています。
...
ビットコインは技術的かつ通貨的な革命であり、私たちとお金や社会との関係を問い直すきっかけとなり得ます。実際、ビットコイン（BTCと呼ばれている）は**中立的**かつ**非中央集権的**な通貨であり、いかなる組織や機関にも支配されません。これは単なる「インターネット通貨」を超えた革新です。コンピュータ・プロトコル（ビットコイン）であり、通貨単位（ビットコイン）でもあります。

ビットコインのプロトコルは、暗号技術、ネットワーク通信、有名な「ブロックチェーン」などの要素技術を使用し、ビットコイン単位はこのプロトコルが適切に機能するために必要な通貨としての役割を果たしています。日常生活において、エルサルバドルの人々や世界中のビットコイナーたちは、この技術を頼りに生活をより良くするために、ビットコイン通貨を用いて商品やサービスの売買を行っています。

**包括的でありながら理解しやすいカリキュラム：**

このコースでは、ビットコインの購入・売却方法、デジタルウォレットでの安全な保管方法、取引での活用方法など、ビットコインの貨幣的側面について解説します。また、新しいビットコインを生成し、ビットコインネットワークを保護するために不可欠なマイナーの役割についても考察します。最後に、ビットコインの将来性と、ライトニングネットワーク技術がビットコイン取引をどのように向上させ得るかを探求します。

![image](assets/ja/001.webp)

ビットコインが、私たちとお金との関係を根本から変える新たな貨幣システムであることを理解することは必要不可欠です。そのため、自身の資金を管理したいと考える者にとって、その活用方法を学ぶことは必須のスキルとなります。
...
- 第21章 - ライトニングネットワークのユースケース  
- 第22章 - 赤い薬か青い薬か？  

貨幣の定義と社会における機能（第1章）を紹介する前に、ビットコインの成り立ちから始めましよう。2009年に誕生したビットコインは、他に類を見ない比較的新しい技術です。そのため、全てを一度に理解できなくて当然です。実際、インターネットの使い方や車の運転の方法を学ぶ場合と同様に、技術的な詳細を今すぐ全て知る必要はありません。まずは資金の受け取り方、支払い方、保護方法などを学ぶことから始め、その後少しずつ、より深く学んでいけばよいのです。

何しろ、私たちはまだ導入の初期段階にあり、離陸期を過ぎたばかりです。この重要な革新について、思う存分知識を身につけるには絶好のタイミングなのです。

![image](assets/ja/002.webp)

ここで重要なのは、この新しい技術を概略的に理解することです。本コースをお楽しみいただけますと幸いです。また、この新たなグローバル・マネタリー・パラダイムの中で更なる進歩を遂げていかれますよう願っております。

ビットコインの魅力的な世界に飛び込み、そのすべての仕組みを理解する準備はできましたか？さあ、始めましょう！

**注記**: コース中に見慣れない用語があった場合は、[用語集](https://planb.academy/resources/glossary)をご参照ください。

## ビットコイン前史

<chapterId>9a94b627-5b69-5d81-9125-f1fa9b0aa6ad</chapterId>

「ビットコイン」という言葉がデジタル通貨と金融変革の代名詞となる前に、その誕生の基盤は一連のアイデア、イノベーション、社会運動によって築かれていました。中でもサイファーパンク運動は、ビットコインの前史における重要な要素として際立っています。

### サイファーパンクス：デジタル世界の先見者たち

![image](assets/ja/003.webp)

1980年代から 1990年代にかけての技術革新の真っ只中、ある集団がデジタル時代におけるプライバシーと自由の役割に深い疑問を抱き始めました。後に「サイファーパンクス」と呼ばれることとなる彼らは、暗号技術が政府や大企業による干渉から個人の権利を守る手段となり得ると固く信じていました。

ジュリアン・アサンジ、ウェイ・ダイ、ティム・メイ、デイヴィッド・チャウムといった象徴的な人物たちが、この運動の理念とビジョンを形成する上で極めて重要な役割を果たしました。これらの思想家たちは、影響力のあるメーリングリスト上でアイデアを共有し、世界中の参加者が技術を活用して個人の自由を拡大する最善の方法をめぐる議論を交わしました。

### サイファーパンクスの3つの基本論文

![image](assets/ja/004.webp)

デジタル・アクティビズムと暗号技術に深く根ざしたサイファーパンク運動は、その理念と未来へのビジョンを明確にするために、いくつかの基礎的文献を参照しました。その中でも、特に3つの著作が際立っています。：

- 「サイファーパンク宣言」：

1993年にエリック・ヒューズによって執筆された「サイファーパンク宣言」は、プライバシーは基本的権利であると主張しています。著者は、自由かつ機密性を保って意思疎通をする能力が、自由な社会にとって不可欠であると述べています。マニフェストにはこうあります：「政府や企業、その他の巨大で顔の見えない組織が私たちにプライバシーを保障してくれるとは期待できない。プライバシーを少しでも守りたければ、自らで守らなければならない。」

- 「クリプトアナーキスト宣言」：

1992年にティモシー・C・メイによって執筆されたこの文書は、暗号技術を利用することによって、政府が市民の私的な活動に干渉できない、暗号無政府主義の時代をもたらしうることを説明しています。メイは、人々が第三者の介入なしに匿名で情報や金銭をやり取りする未来を思い描いていました。

- 「サイバースペース独立宣言」：

サイファーパンクに限ったことではありませんが、この文章はこの運動に参加する多くの人々の気持ちを反映しています。1996年にジョン・ペリー・バーロウによって執筆され、政府によるインターネットの規制が強まることへの反論として記されました。この宣言は、サイバースペースは物理的な領域とは異なる領域であり、同じ法律の適用対象となるべきではないと主張しています。「我々には選挙で選ばれた政府は存在せず、今後も存在しないだろう」と述べています。

### ビットコインの前身

ビットコインが登場する以前にも、デジタル通貨を作ろうとする試みは幾度か行われていました。例えば、デイヴィッド・チャウムは1980年代に「DigiCash」というプロジェクトを通じて「匿名の電子マネー」という概念を導入しました。しかし、様々な制約により、残念ながらDigiCashが普及することはありませんでした。

もうひとつの重要な先駆けは、ウェイ・ダイの「B-money」です。実現されることはなかったものの、中央集権的な権威ではなく評価者コミュニティによって不正検知が行われる匿名のデジタル通貨という概念を提示しました。

下の画像は、数々の技術革新によるムーブメントの発展を分かりやすく示したものです。

![image](assets/ja/005.webp)

2008年、この豊かな環境の中で謎の人物、サトシ・ナカモトがビットコインのホワイトペーパーを発表しました。この文書で彼は、プルーフ・オブ・ワークや暗号タイムスタンプなど、サイファーパンク運動から複数のアイデアを組み合わせ、分散型で検閲に強いデジタル通貨を創出しました。

しかし、ビットコインはそれ以上に、サイファーパンクの理想の達成を体現していました。単なる技術を超えて、伝統的な金融システムに対する革命を象徴し、透明性、分散化、個人の主権に基づく代替案を提供しました。

### 結論

ビットコインの起源は、サイファーパンク運動とデジタル時代におけるより大きな自由への集団的探求に深く根ざしています。暗号化、分散化、完全性の原理を組み合わせることで、ビットコインは単なる通貨以上の存在となりました。実際、ビットコインは哲学的・技術的革命の産物であり、私たちの世界を再構築し続けています。

したがって、ビットコインは長期にわたって展開されるプロトコルであり、私たちにエネルギー、時間、お金との関係性を問い直すよう促しています。

しかし、ビットコインは「真の」通貨と言えるのでしょうか。これを理解するには、まず貨幣の概念とその様々な形態を理解する必要があります。これについては次章で探求します。

ビットコインの歴史をより詳しく知りたい方には、HIS 201コースを強くお勧めします。本コースでは、ビットコインの起源と緩やかな出現過程、そしてその歴史とコミュニティの始まりについても学ぶことができます。本コースは完全な文献と出典に基づき、数々の逸話も交えて解説します：
...
貨幣の進化は、絶えず変化する経済的ニーズに応えるため、時代を超えて文明が培ってきた創意工夫を映し出す、人類史における興味深い側面です。

![image](assets/ja/006.webp)

### 貝殻から銀行口座まで

元来、通貨は穀物や家畜などの有形資産でした。しかし、これらの商品は腐りやすいという大きな欠点があり、長期的な貯蓄手段としては使いにくかったのです。例えば、不作や家畜の病気によって、一夜にして個人の財産が失われる可能性があります。

こうして、文明が発展し、貿易が新たな地域に拡大するにつれ、普遍的な交換手段の必要性が生じました。人々はまず貝殻や宝石などを試してみたが、彼らが考えていたほど耐久性も希少性もありませんでした。やがて、その希少性、耐久性、分割可能性から、金が標準となりました。当時も今も、金は富と権力の象徴となりました。

![image](assets/ja/007.webp)

### 貨幣の役割とは？

貨幣は非常に洗練されたコミュニケーションツールです：

- 現在と未来のコミュニケーションを可能にするものであり、私たちの時間とエネルギーを、将来において価値が下落するリスクがなく、再利用可能な資産へと変換するからです。
- お互いを知らなくても、同じ言葉を話さなくても、見知らぬ者同士が交換し、取引し、物の価値について合意することができます。

この世界における貨幣の機能を人為的に再現することは難しいです。実際、個人も集団も貨幣を作り出すことはできません。貨幣は市場と自発的な合意から生まれるべき自然現象だからです。この意味で、物価は資源配分において社会を導くシグナルや情報の一部として機能しています。

こうした理由から、貨幣としての金は、以下のようなアリストテレス的機能に基づく4千年にわたる貨幣ダーウィニズムの結果なのです：

- **価値の貯蔵手段**：貨幣は購買力を将来に移転するために使用されるため、耐久性のある素材である必要があります；
- **交換手段**：貨幣は物々交換の代わりに、商品やサービスと交換するために使用でき、それによって取引者間の需要の一致を回避できます；
- **勘定単位**：貨幣は異なる商品の価値を比較し、それらの相対的な利便性をよりよく理解することを可能にします。
...
金は理想的な通貨の条件を満たしています。天然の希少性が価値を高め、その化学的性質が経年劣化しないことを保証している。このような特徴から、金は偉大な**価値の貯蔵庫**となったが、一般的な通貨にはなり得なかった。グローバル化し、デジタル化した世界では、金はそのペースを維持するのに苦労し、金を分割可能にし、簡単に交換できるようにする（つまり、鋳造されたコインを通して）中央の主体を必要とする。
