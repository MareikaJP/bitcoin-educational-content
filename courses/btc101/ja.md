...
貨幣の定義と社会における機能（第 1 章）を紹介する前に、ビットコインの成り立ちから始めましよう。2009年に誕生したビットコインは、他に類を見ない比較的新しい技術です。そのため、全てを一度に理解できなくて当然です。実際、インターネットの使い方や車の運転の方法を学ぶ場合と同様に、技術的な詳細を今すぐ全て知る必要はありません。まずは資金の受け取り方、支払い方、保護方法などを学ぶことから始め、その後少しずつ、より深く学んでいけばよいのです。
...
1980 年代から 1990 年代にかけての技術革新の真っ只中、ある集団がデジタル時代におけるプライバシーと自由の役割に深い疑問を抱き始めました。後に「サイファーパンク」と呼ばれることとなる彼らは、暗号技術が政府や大企業による干渉から個人の権利を守る手段となり得ると固く信じていました。
...
デジタル・アクティビズムと暗号技術に深く根ざしたサイファーパンク運動は、その理念と未来へのビジョンを明確にするために、いくつかの基礎的文献を参照しました。その中でも、特に 3 つの著作が際立っています。：

- 「サイファーパンク宣言」：

1993 年にエリック・ヒューズによって書かれた「サイファーパンク宣言」は、プライバシーは基本的権利であると主張しています。著者は、自由かつ機密性を保って意思疎通をする能力が、自由な社会にとって不可欠であると述べています。マニフェストにはこうあります：「政府や企業、その他の巨大で顔の見えない組織が私たちにプライバシーを保障してくれるとは期待できない。プライバシーを少しでも守りたければ、自らで守らねばならない。」と述べています。
